...
namespace App\Http\Controllers\Api\ZoomStudents\Media;
...
class CoursesMediaController extends ApiController
{
    /**
     * @param int $sectionId
    ...
    public function sessionMaterial(int $materialId): StreamedResponse
    {
        ...
        $canAccess = $material->session()->whereHas('level.groups.students', function (Builder $q) {
