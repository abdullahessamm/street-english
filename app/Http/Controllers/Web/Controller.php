...
class Controller extends BaseController
{
    ...
    protected function getUniversalPath($path, $default_path = null)
    {
        if(empty($path))
        {
            $this->errorMsg("Path can't be empty");
        ...
        if($default_path == null){
            ...
            $app_path = config('app.main_path');

        }elseif($default_path == 'admin'){

            $app_path = config('app.admin_path');
        }
    ...
    {
        file_exists($file) && !is_dir($file) ? \unlink($file) : true;
    }
