...
namespace App\Http\Controllers\Web\Pages\Bundles;
...
class BundleController extends Controller
{
    public function index()
    {
        ...
        return view('web.pages.bundle.index')->with('bundles', $bundles);
    }
    ...
    public function show($slug)
    {
        ...
        return view('web.pages.bundle.show')->with('bundle', $bundle);
    }
