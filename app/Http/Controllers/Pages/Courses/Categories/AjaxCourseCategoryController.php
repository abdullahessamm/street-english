...
class AjaxCourseCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        ->editColumn('delete_category', function ($CourseCategory) {
            return '<button class="btn btn-danger font-weight-bold deleteCourseCategory" data-course-category-id="'.$CourseCategory->id.'">مسح '.$CourseCategory->category_name.'</button>';
        })
