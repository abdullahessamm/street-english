<form id="updateVideo">
    ...
    <div class="modal-header">
        <h5 class="modal-title updateLessonTitle" id="previewLessonModalLabel" contenteditable="true" data-lesson-id="{{ $onlineCourseLesson->id }}">
            {{ $onlineCourseLesson->title }}
        </h5>
    ...
    <div class="modal-body">
        ...
        <div class="form-group text-left">
            <label for="video_type">تغيير نوع الفيديو</label>
        ...
        <div class="form-group text-left">
            <label for="video_url">تغيير رابط الفيديو</label>
        ...
        <div class="form-group text-left">
            <label for="video_description">تغيير شرح الدرس</label>
            <textarea name="video_description" class="form-control" id="video_description" cols="30" rows="3" required dir="ltr">{{ $onlineCourseLesson->video_description }}</textarea>
            <small id="update_video_res"></small>
        </div>


        <div class="form-group text-left">
            <button type="submit" class="btn btn-warning font-weigh-bold text-dark btn-sm font-weight-bold" id="updateVideoBtn">تحديث</button>
            <button class="btn btn-danger btn-sm font-weight-bold deleteLesson" data-lesson-id="{{ $onlineCourseLesson->id }}">مسح هذا الفيديو</button>
        </div>
    </div>
</form>