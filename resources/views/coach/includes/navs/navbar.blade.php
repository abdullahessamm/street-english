                ...
                <ul class="nav navbar-nav d-none d-sm-flex flex justify-content-start ml-8pt">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="{{ route('online-courses') }}" class="dropdown-item">الدورات الاونلاين</a>
                ...
                <div class="nav navbar-nav ml-auto mr-0 flex-nowrap d-flex">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="{{ route('coach.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                الخروج
                            </a>

                            <form id="logout-form" action="{{ route('coach.logout') }}" method="POST" class="d-none">
                                @csrf
                            </form>
                        </div>
                    </div>
