@extends('layouts.app',[
    'title' => $lesson->title,
    'active' => 'student.my-course',
    'assets' => 'student.pages.my-course.lesson',
])
                ...
                <div class="content-column col-lg-8 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="course-video-box">
                            @switch($lesson->type)
                                @case('video')
                                    @include('student.pages.my-course.preview-lesson.video',[
                                        'lesson' => $lesson
                                    ])
                                @break
                                    
                                @case('audio')
                                    @include('student.pages.my-course.preview-lesson.audio',[
                                        'lesson' => $lesson
                                    ])
                                @break
                            
                                @case('doc')
                                    @include('student.pages.my-course.preview-lesson.doc',[
                                        'lesson' => $lesson
                                    ])
                                @break
                            
                                @case('frame')
                                    @include('student.pages.my-course.preview-lesson.iframe',[
                                        'lesson' => $lesson
                                    ])
                                @break
                            
                                @case('exercise')
                                    @include('student.pages.my-course.preview-lesson.exercise',[
                                        'lesson' => $lesson
                                    ])
                                @break
                            ...
                            <li class="accordion block">
                                ...
                                <div class="acc-content {{ $lesson->belongsToContent->id == $myCourse->contents[$i]->id ? 'current' : null }}">
                                    ...
                                    <div class="content">
                                        <div class="clearfix">
                                            <div class="pull-left">
                                                <a href="{{ route('student.my-course.lesson', [$myCourse->slug, $eachLesson->slug]) }}" class="play-icon">
