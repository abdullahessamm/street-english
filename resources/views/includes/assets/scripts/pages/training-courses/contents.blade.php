...
$(document).ready(function(){
    ...
    $("#createNewContent").on('submit', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.training-course.content.create') }}",
            type : "POST",
    ...
    $(".updateContentTitle").on('keyup', function(e){
        ...
        $.ajax({
            url : "{{ route('ajax.training-course.content.title.update') }}",
            type : "POST",
            data : {
                "_token" : "{{ csrf_token() }}",
    ...
    $(".updateContentDescription").on('keyup', function(e){
        ...
        $.ajax({
            url : "{{ route('ajax.training-course.content.description.update') }}",
            type : "POST",
            data : {
                "_token" : "{{ csrf_token() }}",
                "content_id" : content_id,
    ...
    $("#confirmDeleteContent").on('click', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.training-course.content.delete') }}",
            type : "POST",
            data : {
				"_token" : "{{ csrf_token() }}",
				"content_id" : content_id,
    ...
    $(".addNewLessons").on('submit', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.training-course.content.lesson.create') }}",
            type : "POST",
            data : new FormData(this),
            contentType : false,
            processData : false,
    ...
    $(".updateLessonTitle").on('keyup', function(e){
        ...
        $.ajax({
            url : "{{ route('ajax.training-course.content.lesson.title.update') }}",
            type : "POST",
            data : {
                "_token" : "{{ csrf_token() }}",
                "lesson_id" : lesson_id,
    ...
    $(".deleteLesson").on('click', function(e){
        ...
        $.ajax({
            url : "{{ route('ajax.training-course.content.lesson.delete') }}",
            type : "POST",
            data : {
                "_token" : "{{ csrf_token() }}",
                "lesson_id" : lesson_id,
    ...
    $(".previewLessonVideo").on('click', function(){
        ...
        callAjax("{{ route('ajax.training-course.content.lesson.preview-video') }}", {'lesson_id' : lesson_id}) 
    });
    ...
    $(document).on('submit', '#updateVideo', function(e){
        ...
        $.ajax({
            url : "{{ route('ajax.training-course.content.lesson.video.update') }}",
            type : "POST",
            data : new FormData(this),
            contentType : false,
            processData : false,
    ...
    $(".lockOrUnlockLesson").on('change', function(){
        ...
        var route = "{{ route('ajax.training-course.content.lesson.lock-or-unlock-lesson') }}";
