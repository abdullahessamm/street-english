...
$(document).ready(function(){
    ...
    $("#createNewContent").on('submit', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.create') }}",
            type : "POST",
    ...
    $(".updateContentTitle").on('keyup', function(e){
        ...
        $.ajax({
            url : "{{ route('ajax.course.content.title.update') }}",
            type : "POST",
            data : {
                "_token" : "{{ csrf_token() }}",
    ...
    $(".updateContentDescription").on('keyup', function(e){
        ...
        $.ajax({
            url : "{{ route('ajax.course.content.description.update') }}",
            type : "POST",
            data : {
                "_token" : "{{ csrf_token() }}",
                "content_id" : content_id,
    ...
    $("#confirmDeleteContent").on('click', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.delete') }}",
            type : "POST",
            data : {
				"_token" : "{{ csrf_token() }}",
				"content_id" : content_id,
    ...
    $(".addNewLessons").on('submit', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.create') }}",
            type : "POST",
            data : new FormData(this),
            contentType : false,
            processData : false,
    ...
    $(".updateLessonTitle").on('keyup', function(e){
        ...
        $.ajax({
            url : "{{ route('ajax.course.content.lesson.title.update') }}",
            type : "POST",
            data : {
                "_token" : "{{ csrf_token() }}",
                "lesson_id" : lesson_id,
    ...
    $(".previewLessonVideo").on('click', function(){
        ...
        callAjax("{{ route('ajax.course.content.lesson.preview-video') }}", {'lesson_id' : lesson_id}) 
    });
    ...
    $(".lockOrUnlockLesson").on('change', function(){
        ...
        var route = "{{ route('ajax.course.content.lesson.lock-or-unlock-lesson') }}";
