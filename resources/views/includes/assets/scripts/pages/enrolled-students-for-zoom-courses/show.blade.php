...
$(document).ready(function(){
    ...
    $(".suspendOrUnSuspendStudent").on('change', function(e){
        ...
        $(this).is(":checked") ? callAjax("{{ route('ajax.enrolled-students-for-courses.student.suspend') }}", data) : callAjax("{{ route('ajax.enrolled-students-for-courses.student.un-suspend') }}", data);
    }); 
    ...
    $("#appendNewStudent").on('submit', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.enrolled-students-for-zoom-courses.append.student') }}",
            type : "POST",
    ...
    $(".removeUser").on('click', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.enrolled-students-for-zoom-courses.student.remove') }}",
            type : "POST",
            data : {
                "_token" : "{{ csrf_token() }}",
