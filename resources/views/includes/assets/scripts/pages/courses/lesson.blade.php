...
$(document).ready(function(){
    ...
    $('#confirmDeleteLesson').on('click', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.delete') }}",
            type : "POST",
            data : {
                "_token" : "{{ csrf_token() }}",
                "lesson_id" : lesson_id,
    ...
    $("#createLessonType").on('click', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.type.create') }}",
            type : "POST",
            data : {
                "_token" : "{{ csrf_token() }}",
                "lesson_id" : lesson_id,
    ...
    $("#isLocked").on('change', function(){
        ...
        var route = "{{ route('ajax.course.content.lesson.is-locked') }}";
    ...
    $("#isContinueable").on('change', function(){
        ...
        var route = "{{ route('ajax.course.content.lesson.is-continueable') }}";
    ...
    $("#isAchievable").on('change', function(){
        ...
        var route = "{{ route('ajax.course.content.lesson.is-achievable') }}";
    ...
    $(".chooseInstructor").on('change', function(){
        ...
        var route = "{{ route('ajax.course.content.lesson.instructor') }}";
    ...
    $(document).on('click', '#addPoints', function(e){
        ...
        callAjax("{{ route('ajax.course.content.lesson.add-points') }}", {'points': points, 'lesson_id' : lesson_id});
    });
    ...
    $("#updateLessonDescription").on('click', function(e){
        ...
        callAjax("{{ route('ajax.course.content.lesson.description.update') }}", {'lesson_description': lesson_description, 'lesson_id' : lesson_id});
    });
    ...
    $("#isPublished").on('change', function(){
        ...
        var route = "{{ route('ajax.course.content.lesson.is-published') }}";
    ...
    $(document).on('submit', '#createVideoCourse', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.video.upload') }}",
            type : "POST",
    ...
    $(document).on('change', '#isVideoDownloadable', function(){
        ...
        var route = "{{ route('ajax.course.content.lesson.video.is-downloadable') }}";
    ...
    $(document).on('submit', '#updateVideoCourse', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.video.update') }}",
            type : "POST",
            data : new FormData(this),
            contentType : false,
            processData : false,
    ...
    $(document).on('submit', '#createAudioCourse', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.audio.upload') }}",
            type : "POST",
            data : new FormData(this),
            contentType : false,
            processData : false,
    ...
    $(document).on('submit', '#updateAudioCourse', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.audio.update') }}",
            type : "POST",
            data : new FormData(this),
            contentType : false,
            processData : false,
    ...
    $(document).on('change', '#isAudioDownloadable', function(){
        ...
        var route = "{{ route('ajax.course.content.lesson.audio.is-downloadable') }}";
    ...
    $(document).on('submit', '#createDocCourse', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.doc.upload') }}",
            type : "POST",
            data : new FormData(this),
            contentType : false,
            processData : false,
    ...
    $(document).on('change', '#isDocDownloadable', function(){
        ...
        var route = "{{ route('ajax.course.content.lesson.doc.is-downloadable') }}";
    ...
    $(document).on('submit', '#updateDocCourse', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.doc.update') }}",
            type : "POST",
            data : new FormData(this),
            contentType : false,
            processData : false,
    ...
    $(document).on('click', '#updateDocPages', function(e){
        ...
        callAjax("{{ route('ajax.course.content.lesson.doc.pages.update') }}", {'pages': pages, 'lesson_doc_id' : lesson_doc_id});
    });
    ...
    $(document).on('submit', '#createCourseContext', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.context.create') }}",
            type : "POST",
            data : new FormData(this),
            contentType : false,
            processData : false,
    ...
    $(document).on('submit', '#updateCourseContext', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.context.update') }}",
            type : "POST",
            data : new FormData(this),
            contentType : false,
            processData : false,
    ...
    $(document).on('submit', '#createCourseFrame', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.iframe.create') }}",
            type : "POST",
            data : new FormData(this),
            contentType : false,
            processData : false,
    ...
    $(document).on('submit', '#updateCourseFrame', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.iframe.update') }}",
            type : "POST",
            data : new FormData(this),
            contentType : false,
            processData : false,
    ...
    $(document).on('submit', '#createCourseExercise', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.exercise.create') }}",
            type : "POST",
            data : new FormData(this),
            contentType : false,
            processData : false,
    ...
    $(document).on('submit', '#updateCourseExercise', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.content.lesson.exercise.update') }}",
            type : "POST",
            data : new FormData(this),
            contentType : false,
            processData : false,
