...
$(document).ready(function(){
    ...
    $('#deleteCourse').on('click', function(e){
        ...
        var Ietls_course_id = $(this).data("course-id");

        $("#deleteCourseModal").modal('show');

        $("#confirmdeleteCourseID").val(Ietls_course_id);
    });
    ...
    $("#publishCourse").on('click', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.ietls-course.publish') }}",
            type : "POST",
            data : {
				"_token" : "{{ csrf_token() }}",
				"Ietls_course_id" : Ietls_course_id,
    ...
    $("#unPublishCourse").on('click', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.ietls-course.un-publish') }}",
            type : "POST",
            data : {
				"_token" : "{{ csrf_token() }}",
				"Ietls_course_id" : Ietls_course_id,
