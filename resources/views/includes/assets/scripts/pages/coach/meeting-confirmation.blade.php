<script>
    $(document).ready(function(){
        ...
        var countDownDate = new Date('{{ date("M d, y H:i:s", strtotime($coachSessionBooking->belongsToAppointment->belongsToCoachSessionDate->date.' '.$coachSessionBooking->belongsToAppointment->start_time)) }}').getTime();
        ...
        var x = setInterval(function() {
            ...
            if (distance < 0) 
            {
                ...
                window.location.replace("{{ $coachSessionBooking->belongsToAppointment->link }}");
            }
