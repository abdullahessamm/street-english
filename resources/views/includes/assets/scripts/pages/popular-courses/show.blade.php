...
$(document).ready(function(){
    ...
    $(".suspendOrUnSuspendStudent").on('change', function(e){
        ...
        $(this).is(":checked") ? callAjax("{{ route('ajax.enrolled-students.student.suspend') }}", data) : callAjax("{{ route('ajax.enrolled-students.student.un-suspend') }}", data);
    }); 
    ...
    $("#appendNewStudent").on('submit', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.enrolled-students.append.student') }}",
            type : "POST",
    ...
    $(".removeUser").on('click', function(e){
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.enrolled-students.student.remove') }}",
            type : "POST",
            data : {
                "_token" : "{{ csrf_token() }}",
