...
$(document).ready(function(){
    ...
    $(".preview-lesson").on('click', function(){
        ...
        $.ajax({
            ...
            type : "POST",
            url : "{{ route('ajax.course.preview-lesson') }}",
            data : {
                "_token" : "{{ csrf_token() }}",
                "lesson_id" : lesson_id,
            },
            ...
            {
                $("#loading").modal('hide');
                $("#previewLessonModal").modal({backdrop: 'static', keyboard: false});
                $("#previewLessonModal").modal("show");
                $("#preview_lessons_res").html(data);
            },
    ...
    $("#buyCourse").on('submit', function(e){
        e.preventDefault();
        ...
        $.ajax({
            ...
            url : "{{ route('ajax.course.buy-course') }}",
            type :'POST',
            data : new FormData(this),
            contentType : false,
            processData : false,
