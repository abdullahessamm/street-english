                                                            ...
                                                            <div class="clearfix">
                                                                <div class="pull-left">
                                                                    ...
                                                                    @switch($lesson->type)
                                                                        ...
                                                                        <a href="{{ route('ielts-user.my-course.lesson', [$lesson->belongsToContent->belongsToCourse->slug, $lesson->slug]) }}" class="preview-lesson play-icon" data-lesson-id="{{ $lesson->id }}"><span class="fa fa-video-camera"></span>{{ $lesson->title }}</a>
                                                                        @else
                                                                        <a href="{{ route('ielts-user.my-course.lesson', [$lesson->belongsToContent->belongsToCourse->slug, $lesson->slug]) }}" class="play-icon" ><span class="fa fa-lock"></span>{{ $lesson->title }}</a>
                                                                        @endif
                                                                        </div>
                                                                        @break
