@extends('layouts.app',[
    'title' => 'Create New IELTS Account'
])
            ...
            <div class="styled-form">
                <form method="POST" action="{{ route('ielts-user.register') }}" novalidate>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                            <div class="users">Already have an account? <a href="{{ route('ielts-user.login') }}">Sign In</a></div>
                        </div>
