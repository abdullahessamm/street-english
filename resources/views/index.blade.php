        ...
        <div class="row justify-content-center">
            ...
            <div class="title-column col-lg-8 col-md-12 col-sm-12 text-center">
                ...
                <div class="btns-box mt-5">
                    ...
                    <a href="{{ route('placement-test') }}" class="theme-btn btn-style-five"><span class="txt">Placement Test</span></a>
                </div>
            </div>
                    ...
                    <div class="inner wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="content">
                            ...
                            <div class="count-outer count-box alternate" style="color: #18a674;">
                                <span class="count-text" data-speed="3000" data-stop="{{ App\User::count() }}">0</span>K+
                            </div>
                        </div>
                    </div>
                </div>
