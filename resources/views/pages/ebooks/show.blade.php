        ...
        <div class="row clearfix">
            ...
            <div class="info-column col-lg-4 col-md-12 col-sm-12">
                <div class="inner-column">
                    ...
                    @else
                    <a href="{{ asset('public/uploads/books/'.$book->id.'/book/'.$book->book) }}" download="{{$book->book_name}}" class="theme-btn btn-style-two"><span class="txt">Download <i class="fa fa-download"></i></span></a>
                    @endif
                </div>
            </div>
