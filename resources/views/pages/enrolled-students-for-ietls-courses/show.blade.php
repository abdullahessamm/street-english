@extends('layouts.app', [
    'title' => 'Enrolled Students in : '.$Course->name,
    'active' => 'enrolled-students-for-ietls-courses',
    'breadcrumb' => [
        'title' => 'Enrolled Students in : '.$Course->name,
        'map' => [
            'Dashboard' => 'home',
            'Enrolled Students' => 'enrolled-students-for-courses',
            'Enrolled Students in : <b>'.$Course->name.'</b>' => 'active',
        ]
    ],
    'header_right' => [
		'btn' => [
    ...
    'assets' => 'pages.enrolled-students-for-ietls-courses.show'
])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">List of all Enrolled Stuents in <b>{{ $Course->name }}</b></h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                            @foreach($Course->enrolledStudents as $eachStudent)
                                <tr id="tr_student_{{$eachStudent->id}}">
                                    <td><a href="{{ route('ietls-course.user.show', $eachStudent->ietls_user_id) }}">{{ $eachStudent->belongsToStudent->name }}</a></td>
                                    <td>
