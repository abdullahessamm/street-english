				...
				<div class="our-courses">
					...
					@if($courses->count() > 0)
						...
						<div class="cource-block-two col-lg-4 col-md-6 col-sm-12">
							<div class="inner-box">
								<div class="image">
									<a href="{{ route('ietls-course.show', $course->slug) }}"><img src="{{ asset('images/ietls-courses/'.$course->id.'/'.$course->thumbnail) }}" style="width: 270px;height: 150px;" alt="" /></a>
								</div>
								<div class="lower-content">
									<h5><a href="{{ route('ietls-course.show', $course->slug) }}">{{ $course->name }}</a></h5>
									...
									<div class="clearfix">
										...
										@if($course->discount != null)
											<div class="hours">
												{{ $course->discount->discount }} EGP
												<br>
												<small><del class="text-danger">{{ $course->discount->price }} EGP</del></small>
											</div>
										@else
