@extends('layouts.app', [
    'title' => "Registed Users Exams",
    'active' => 'registed-users-exams',
    'breadcrumb' => [
        'title' => "Registed Users Exams",
        'map' => [
            'Dashboard' => 'home',
            "Registed Users Exams" => 'active',
        ]
    ],
    'scripts' => 'pages.registed-users-exams.index'
])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">List of all registed users</h4>
