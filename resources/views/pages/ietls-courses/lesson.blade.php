@extends('layouts.app', [
    ...
    'assets' => 'pages.ietls-courses.lesson'
])
...
@switch($lesson->type)
	@case('video')
		@include('pages.ietls-courses.lesson-type.video',[
			'lesson' => $lesson
		])
	@break
		
	@case('audio')
		@include('pages.ietls-courses.lesson-type.audio',[
			'lesson' => $lesson
		])
	@break

	@case('doc')
		@include('pages.ietls-courses.lesson-type.pdf',[
			'lesson' => $lesson
		])
	@break

	@case('context')
		@include('pages.ietls-courses.lesson-type.context')
	@break

	@case('frame')
		@include('pages.ietls-courses.lesson-type.frame')
	@break

	@case('exercise')
		@include('pages.ietls-courses.lesson-type.exercise')
	@break
@endswitch
