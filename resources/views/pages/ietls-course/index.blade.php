				...
				<div class="our-courses">
					...
					@if($courses->count() > 0)
						...
						<div class="cource-block-two col-lg-4 col-md-6 col-sm-12">
							<div class="inner-box">
								<div class="image">
									<a href="{{ route('ietls-course.show', $course->slug) }}"><img src="{{ asset('images/ielts-courses/'.$course->id.'/'.$course->thumbnail) }}" style="width: 270px;height: 150px;" alt="" /></a>
								</div>
								<div class="lower-content">
									<h5>
										<a style="color: #18a674;" href="{{ route('ietls-course.show', $course->slug) }}">{{ $course->name }}</a>
									</h5>
