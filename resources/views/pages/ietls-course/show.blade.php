            ...
            <div class="row clearfix">
                ...
                <div class="video-column col-lg-4 col-md-12 col-sm-12">
                    <div class="inner-column sticky-top">
                        ...
                        @if(Auth::guard('ielts_user')->check() && Auth::guard('ielts_user')->user()->course($course->id) != null)
                            @php
                                $lessons = $course->lessons;
                                $firstLesson = $lessons[0];
                            @endphp
                            <a  href="{{ route('ielts-user.my-course.lesson', [$course->slug, $firstLesson->slug]) }}" class="theme-btn btn-style-three mt-3"><span class="txt">Complete this course</span></a>
                        @elseif(Auth::guard('ielts_user')->check() && Auth::guard('ielts_user')->user()->course($course->id) == null)
            ...
            <form id="loginToBuyCourse">
                ...
                <div class="modal-body">
                    <div class="my-3 text-center">
                        ...
                        <small>Don't have an account don't worry <a href="{{ route('ielts-user.register') }}">Click here to create new account</a></small>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="buyCourse">
                {{ csrf_field() }}
                <input type="hidden" name="course_id" value="{{ $course->id }}">
                <input type="hidden" name="user_id" value="{{ Auth::guard('ielts_user')->user()->id }}">
                <div class="modal-body">
