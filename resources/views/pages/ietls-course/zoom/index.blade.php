    ...
    <div class="auto-container mt-5">
        ...
        <div class="row clearfix">
            ...
            <div class="cource-block-two col-lg-3 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="image">
                        <a href="{{ route('zoom-live-course.show', $zoomCourse->slug) }}"><img src="{{ asset('public/images/zoom-courses/'.$zoomCourse->id.'/'.$zoomCourse->image) }}" style="width: 270px;height: 150px;" alt="" /></a>
                    </div>
