@extends('layouts.app', [
    ...
    'active' => 'enrolled-students-for-courses',
    'breadcrumb' => [
        'title' => 'Enrolled Students in : '.$Course->name,
        'map' => [
            'Dashboard' => 'home',
    ...
    'assets' => 'pages.enrolled-students-for-courses.show'
])
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            @foreach($Course->enrolledStudents as $eachStudent)
                                <tr id="tr_student_{{$eachStudent->id}}">
                                    <td><a href="{{ route('student.show', $eachStudent->user_id) }}">{{ $eachStudent->belongsToStudent->name }}</a></td>
                                    <td>
