	    ...
	    <div class="col-md-12">
	        <div class="card">
	            <div class="card-header">
	                <h4 class="card-title" id="striped-label-layout-basic">Create student details</h4>
	            ...
	            <div class="card-content collapse show">
	                <div class="card-body">
	                    <form id="createNewStudent" class="form form-horizontal striped-labels form-bordered">
                            {{ csrf_field() }}
	                    	<div class="form-body">
	                    		<h4 class="form-section"><i class="fa fa-user"></i> Student Info</h4>
