@extends('layouts.app', [
    ...
    'breadcrumb' => [
        ...
        'map' => [
            ...
            'Create new Training Course' => 'active'
        ]
    ],
    'assets' => 'pages.training-courses.create'
])
	    ...
	    <div class="col-md-12">
	        <div class="card">
	            <div class="card-header">
	                <h4 class="card-title" id="striped-label-layout-basic">Create Training Course details</h4>
	                    ...
	                    <form id="createNewCourse" class="form form-horizontal striped-labels form-bordered">
	                    	...
	                    	<div class="form-body">
			                    ...
			                    <div class="form-group row">
		                            ...
		                            <div class="col-md-9">
		                            	<input type="text" id="training_course_name" class="form-control" name="training_course_name" required>
		                            </div>
		                        </div>
								...
								<div class="form-group row">
		                            ...
		                            <div class="col-md-9">
										<select class="select2 form-control" id="training_course_category_id" name="training_course_category_id">
											...
											<option value="{{ $trainingCourseCategory->id }}">{{ $trainingCourseCategory->category_name }}</option>
											@endforeach
										</select>
		                            </div>
		                        </div>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-md-9">
										<textarea dir="ltr" name="map" class="form-control" id="map" cols="30" rows="10"></textarea>
		                            </div>
		                        </div>
...
<div class="modal" id="errorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content text-right">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" id="onCloseErrorModal"> Close Window </button>
            </div>
        </div>
    </div>
</div>
