@extends('layouts.app', [
    'title' => 'Online course : '.$course->name,
	'active' => 'courses',
    'breadcrumb' => [
        'title' => $course->name,
        'map' => [
	                    	...
	                    	<div class="form-body">
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
										...
										<img src="{{ config('app.main_url').'/public/images/courses/'.$course->id.'/'.$course->thumbnail }}" class="img-fluid" alt="{{ $course->name }}">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-9">
										...
										<img src="{{ config('app.main_url').'/public/images/courses/'.$course->id.'/'.$course->banner }}" class="img-fluid" alt="{{ $course->name }}">
										@endif
									</div>
								</div>
