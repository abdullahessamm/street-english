                                                        ...
                                                        <div class="row clearfix">
															...
															<div class="student-block col-lg-6 col-md-6 col-sm-12 mb-3">
																<div class="block-inner">
																	<div class="image">
                                                                        @if(isset($instructor->info) && $instructor->info->image !== null)
																		<img src="{{ $instructor->info->image }}" style="width: 278px;height: 319px;" alt="{{ $instructor->name }}" />
                                                                        @else
																		<img src="{{ asset('public/assets/images/avatars/avatar2.png') }}" style="width: 278px;height: 319px;" alt="{{ $instructor->name }}" />
                                                                        @endif
																	</div>
																	<h2 class="mb-2">{{ $instructor->name }}</h2>
																	{{-- <div class="text">Certified instructor Architecture& Developer</div> --}}
																	<div class="social-box">
																		<a href="{{ isset($instructor->info) && $instructor->info->facebook !== null ? $instructor->info->facebook : 'javascript:void(0);' }}" class="fa fa-facebook-square"></a>
																		<a href="{{ isset($instructor->info) && $instructor->info->twitter !== null ? $instructor->info->twitter : 'javascript:void(0);' }}" class="fa fa-twitter-square"></a>
																		<a href="{{ isset($instructor->info) && $instructor->info->linkedIn !== null ? $instructor->info->linkedIn : 'javascript:void(0);' }}" class="fa fa-linkedin-square"></a>
																	</div>
																	<a href="{{ route('instructor.show', $instructor->id) }}" class="more">Know More <span class="fa fa-angle-right"></span></a>
																</div>
															</div>
                                                            @endforeach
														</div>
                                                            ...
                                                            <div class="clearfix">
                                                                <div class="pull-left">
                                                                    ...
                                                                    @switch($lesson->type)
                                                                        ...
                                                                        <a href="javascript:void(0);" class="preview-lesson play-icon" data-lesson-id="{{ $lesson->id }}"><span class="fa fa-video-camera"></span>{{ $lesson->title }}</a>
                                                                        @else
                ...
                <div class="video-column col-lg-4 col-md-12 col-sm-12">
                    <div class="inner-column sticky-top">
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            {{-- <video class="embed-responsive-item" src="https://www.youtube.com/embed/{{$course->video_url}}?rel=0" allowfullscreen></video> --}}
                            handle after backend finish
                        </div>
                        <!-- End Video Box -->
                        @endif
