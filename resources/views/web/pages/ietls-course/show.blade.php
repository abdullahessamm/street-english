            ...
            <div class="row clearfix">
                                                        ...
                                                        <div class="row clearfix">
															...
															<div class="student-block col-lg-6 col-md-6 col-sm-12 mb-3">
																<div class="block-inner">
																	<div class="image">
                                                                        @if(isset($eachInstructor->info) && $eachInstructor->info->image !== null)
																		<img src="{{ asset('public/images/coaches/'.$eachInstructor->id.'/'.$eachInstructor->info->image) }}" style="width: 278px;height: 319px;" alt="" />
                                                                        @else
																		<img src="{{ asset('public/assets/images/avatars/avatar2.png') }}" style="width: 278px;height: 319px;" alt="" />
                                                                        @endif
																	</div>
																	<h2 class="mb-2">{{ $eachInstructor->name }}</h2>
																	{{-- <div class="text">Certified instructor Architecture& Developer</div> --}}
																	<div class="social-box">
																		<a href="{{ isset($eachInstructor->info) && $eachInstructor->info->facebook !== null ? $eachInstructor->info->facebook : 'javascript:void(0);' }}" class="fa fa-facebook-square"></a>
																		<a href="{{ isset($eachInstructor->info) && $eachInstructor->info->twitter !== null ? $eachInstructor->info->twitter : 'javascript:void(0);' }}" class="fa fa-twitter-square"></a>
																		<a href="{{ isset($eachInstructor->info) && $eachInstructor->info->linkedIn !== null ? $eachInstructor->info->linkedIn : 'javascript:void(0);' }}" class="fa fa-linkedin-square"></a>
																	</div>
																	<a href="{{ route('instructor.show', $eachInstructor->id) }}" class="more">Know More <span class="fa fa-angle-right"></span></a>
																</div>
															</div>
                                                            @endforeach
														</div>
                ...
                <div class="video-column col-lg-4 col-md-12 col-sm-12">
                    <div class="inner-column sticky-top">
                        ...
                        <img src="{{ asset('public/images/courses/'.$course->id.'/'.$course->image) }}" class="img-fluid" alt="">
                        @else
                        <!-- Video Box -->
