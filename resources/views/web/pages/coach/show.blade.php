            ...
            <div class="image-column col-lg-3 col-md-12 col-sm-12">
                <div class="inner-column">
                    ...
                    @if(isset($coach->info) && $coach->info->image != null)
                        <img src="{{ $coach->info->image }}" style="width: 278px;height: 319px;" class="img-fluid" alt="{{ $coach->name }}">
                    @else
                            ...
                            <div class="tabs-content">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="cource-block-two col-lg-4 col-md-6 col-sm-12">
                                                <div class="inner-box">
                                                    <div class="image">
                                                        <a href="{{ route('course.show', $course->slug) }}"><img src="{{ $course->thumbnail }}" style="width: 270px;height: 150px;" alt="{{ $course->name }}" /></a>
                                                    </div>
                                ...
                                <div class="tab" id="bio-overview">
                                    <div class="content">
                                        ...
                                        @if ($coach->info->bio_video)
                                        <div class="row clearfix">
                                            <div class="col-12 text-center">
                                                <video src="{{ $coach->info->bio_video }}" controls></video>
                                            </div>
                                        </div>
                                        @endif
                                    </div>
