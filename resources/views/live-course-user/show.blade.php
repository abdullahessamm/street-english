@extends('layouts.app',[
    'title' => $myZoomCourse->belongsToZoomCourse->title,
    'active' => 'student.home'
])
            ...
            <div class="content-column col-lg-9 col-md-12 col-sm-12">
                <div class="inner-column">
                    <div class="content">
                        <!-- Sec Title -->
                        <div class="sec-title">
                            <h2>{{ $myZoomCourse->belongsToZoomCourse->title }} Levels</h2>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-12">
                                <table class="table">
                                    ...
                                    <tbody>
                                    @foreach($myZoomCourse->zoomCourseLevels as $eachZoomCourseLevel)
                                        <tr>
                                            <td>
                                                <a href="{{ route('live-course.level.show', [$myZoomCourse->id, $eachZoomCourseLevel->zoom_course_level_id]) }}">{{ $eachZoomCourseLevel->belongsToZoomCourseLevel->title }}</a>
                                            </td>
                                            <td style="color: #1E284B;font-weight: bold;">
                                                {{ $eachZoomCourseLevel->zoomCourseSessions->count() }}
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
