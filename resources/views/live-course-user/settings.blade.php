@extends('layouts.app',[
    'title' => 'My Dashboard',
    'active' => 'student.home',
    'scripts' => 'live-course-user.settings',
])
...
<section class="student-profile-section">
    ...
    <div class="auto-container">
        ...
        <div class="row clearfix mt-5">
            ...
            <!-- Image Section -->
            @include('live-course-user.layouts.settings')
                            ...
                            <form method="post" action="blog.html">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-12 form-group">
                                        <input type="text" name="username" placeholder="First Name" required="" value="{{ $user->name }}">
